...
import com.isel.sincroserver.config.JwtAuthenticationEntryPoint;
import com.isel.sincroserver.config.JwtRequestFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                .authorizeRequests().antMatchers("/authenticate/login", "/register/**").anonymous().
